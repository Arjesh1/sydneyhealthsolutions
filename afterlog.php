...
<center><h2><strong class="black">You have logged in sucessfully. Please proceed further for booking.</strong></h2><center>
 ...
 <div class="elem-group inlined">
  ...
  <div class="elem-group">
    <select id="test-type" name="test-type" required>
        ...
        <option value="adjoining">Blood-glucose</option>
